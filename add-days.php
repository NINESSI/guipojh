                    ...
                    <div class="col-md-12">
                        <div class="main-card mb-3 card">
                            ...
                            <div class="card-body">
								...
								<?php $ID = trim(isset($_GET['user']) ? $_GET['user'] : ''); ?>
								<form action="" method="POST">
    								<div class="position-relative form-group">
        								<label for="exampleEmail" class="">Usuario</label>
        								<input type="text" name="usuario" placeholder="Enter a username" class="form-control" value="<?php echo $ID; ?>" required>
    								</div>
    								...
    								<div class="d-block text-right card-footer">
    								    <button type="submit" name="Submit" class="btn btn-success btn-lg">ADICIONAR</button>
    								</div>
								</form>
							</div>
                        </div>
