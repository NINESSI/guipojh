				...
				<div class="row">
                    <div class="col-md-12">
                        <div class="main-card mb-3 card">
                            <div class="card-header">WTP - ALTERA SENHA
                            </div>
                            <div class="card-body">
								<?php if(!empty($_SESSION['acao'])) { echo $_SESSION['acao'].'<hr>'; unset($_SESSION['acao']); } ?>
								<form action="" method="POST">
    								<div class="position-relative form-group">
        								<label for="exampleEmail" class="">Senha Antiga</label>
        								<input type="text" name="oldpass" placeholder="" class="form-control" required>
    								</div>
    								<div class="position-relative form-group">
        								<label for="exampleEmail" class="">Senha Nova</label>
        								<input type="text" name="newpass" placeholder="" class="form-control" required>
    								</div>
    								<div class="position-relative form-group">
        								<label for="exampleEmail" class="">Confirma Senha</label>
        								<input type="text" name="confirmpass" placeholder="" class="form-control" required>
    								</div>
    								<div class="d-block text-right card-footer">
    								    <button type="submit" name="Submit" class="btn btn-info">ALTERAR</button>
    								</div>
								</form>
							</div>
                        </div>
